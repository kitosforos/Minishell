...
SRCS = src/builtins.c src/process.c src/minishell.c src/main.c src/env.c src/env2.c \
		src/builtins2.c src/builtins3.c src/builtins4.c src/redir.c src/signals.c src/ft_split2.c src/quotes.c src/quotes2.c src/quotes3.c \
		 src/quotes4.c src/free.c src/redir2.c src/redir3.c src/process2.c
